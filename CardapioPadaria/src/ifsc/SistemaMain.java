			...
			case 3: {
		        ...
		        case 1:
					...
					if (opc == 1) {
						...
						refrigerante.add("coca-cola");
						
						Produto refrigerante = new Produto();
						
						refrigerante.setNome("Nome do produto agua");
						refrigerante.setCodBarras(5654654l);
						refrigerante.setPreco(5.00);
						refrigerante.setFornecedor("Fornecedor Nicole");
